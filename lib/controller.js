class Controller {
    ...
    buildBudgetOverview() {
        $("#budgetCard").append(`<div class="chart-container"><canvas class="chart" id="budgetOverview"></canvas></div><hr />`);
    ...
    buildBudgetSubjects() {
        $("#budgetCard").append(`<div class="chart-container"><canvas class="chart" id="budgetSubjects"></canvas></div><hr />`);
